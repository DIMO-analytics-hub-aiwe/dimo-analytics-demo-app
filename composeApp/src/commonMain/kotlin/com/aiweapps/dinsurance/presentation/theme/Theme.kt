...
import com.aiweapps.dinsurance.extensions.DEFAULT_CROSS_FADE_ANIMATION_SPEED
import com.aiweapps.dinsurance.presentation.components.systembars.edgeToEdgeModeController
...
fun DinsuranceTheme(
    ...
    Crossfade(
        ...
        MaterialTheme(
            colorScheme = scheme,
            typography = DinsuranceTypography(),
            shapes = Shapes(),
            content = content
        )
    }
